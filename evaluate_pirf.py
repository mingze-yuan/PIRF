...
dict_base_model_pth = {
    'darcy': '/n/netscratch/nali_lab_seas/Everyone/mingze/physics_workspace/workspace_iter20/darcy/00006-darcy_merged-uncond-ddpmpp-edm-gpus2-batch40-fp16/training-state-000180.pt',
    'helmholtz': '/n/netscratch/nali_lab_seas/Everyone/mingze/physics_workspace/workspace_iter20/helmholtz/00001-helmholtz-uncond-ddpmpp-edm-gpus2-batch40-fp16/training-state-000120.pt',
    'poisson': '/n/netscratch/nali_lab_seas/Everyone/mingze/physics_workspace/workspace_iter20/poisson/00001-poisson-uncond-ddpmpp-edm-gpus2-batch40-fp16/training-state-000160.pt',
    'kolmogorov': '/n/netscratch/nali_lab_seas/Everyone/mingze/physics_workspace/workspace/kolmogorov/00001-kolmogorov-uncond-ddpmpp-edm-gpus2-batch40-fp16/network-snapshot-006040.pkl'
}

def generate(net, batch_size=16, device='cuda', sigma_min=0.002, sigma_max=80, rho=7, num_steps=80, seed=0):
...
if __name__ == '__main__':
    ...
    output_base_dir = '/n/netscratch/nali_lab_seas/Everyone/mingze/physics_workspace/results/pirf_iter20train'
